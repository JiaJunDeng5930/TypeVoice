...
- [x] 1.1 定义 ASR Runner 的输入输出协议（JSON）
  ...
  - _Requirements: `docs/verification.md`#3, `docs/tech-spec.md`#4_
  - Completion: 协议写入文档（可先写在 `docs/tech-spec.md` 的 ASR 接口章节里或单独小节）
- [x] 1.2 选择并冻结 ASR Runner 的 Python 依赖集（最小可运行）
  ...
  - _Requirements: `docs/base-spec.md`#3.2, `docs/tech-spec.md`#4.1_
...
- [x] 1.3 实现 ASR Runner（独立进程）
  ...
  - _Requirements: `docs/verification.md`#4,#5_
...
- [x] 1.4 实现验证入口（CLI 或脚本）与指标落盘（JSONL）
  ...
  - _Requirements: `docs/verification.md`#2,#3_
...
- [x] 1.5 取消机制（最小可验收版本）
  ...
  - _Requirements: `docs/base-spec.md`#5.1, `docs/verification.md`#4,#5_
...
- [x] 1.6 fixtures 获取与本机约定固化
  ...
  - _Requirements: `docs/fixtures-sources.md`, `docs/verification.md`#2_
...
- [x] 4.1 引入轻量单元测试框架并建立测试目录
  ...
  - _Requirements: `docs/verification.md`#4,#5, `docs/roadmap.md` M7_
  - Completion: `quick/full` 都能先跑单测再跑原有验证
- [x] 4.2 将单元测试接入 `verify_quick/verify_full`
  - quick 只跑 marker=quick
  - full 跑全部单测
  - _Requirements: `docs/verification.md`_
...
- [x] 8.1 后端提供模型下载/校验/状态查询命令
  ...
  - _Requirements: `docs/base-spec.md`#3.2, `docs/tech-spec.md`#8_
...
- [ ] 9.1 Windows 环境跑通 quick/full
  - _Requirements: `docs/roadmap.md` M12_
