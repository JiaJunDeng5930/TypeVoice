...
当前 Windows bundle 会生成两个安装包：

- `target/release/bundle/nsis/TypeVoice_0.1.0_x64-setup.exe`
- `target/release/bundle/msi/TypeVoice_0.1.0_x64_en-US.msi`

发布到 GitHub Releases 时，把这两个 Windows 安装包上传为 release asset。
