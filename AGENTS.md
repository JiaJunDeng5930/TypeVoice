...
- Useful env overrides: `TYPEVOICE_LLM_BASE_URL`, `TYPEVOICE_LLM_MODEL`, `TYPEVOICE_DATA_DIR`.
...
|apps/desktop:{src-tauri/,src/,.gitignore,index.html,package-lock.json,package.json,README.md,tsconfig.json,tsconfig.node.json,vite.config.ts}
...
|apps/desktop/src/assets:{dropdown-triangle.png,workflow-status-icons.png}
